...
author:     "Yanding"
header-img: "img/react/react.jpg"
...
2. 三种开发方式的原理和对比
![三种开发类型的原理](/img/react/devmedhod.jpeg)
![三种开发类型的对比](/img/react/devcompare.jpeg)
...
![项目开发流程](/img/react/devprocess.jpg)
> 根据需求搞设计，根据设计做开发
...
两种App开发类型的本质区别：
![两种App开发类型的本质区别](/img/react/h5-ionic-rn-weex.jpeg)
